...
export default function CompressedMedia() {
  return (
    
<div className="flex items-start gap-2.5 m-3">
   <img className="w-8 h-8 rounded-full" src="https://avatars.githubusercontent.com/u/25126281?v=4" alt="Bonnie Green image"/>
   <div className="flex flex-col gap-1">
      <div className="flex flex-col w-full max-w-[326px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
         ...
         <div className="group relative my-2.5">
            ...
            <img src="https://images.unsplash.com/photo-1703811096376-1cb9f563961d?q=80&w=1975&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="rounded-lg" />
         </div>
         <div className="flex items-center 
      justify-end
      space-x-2 rtl:space-x-reverse">
         <span className="text-sm font-normal text-gray-500 dark:text-gray-400">11:46</span>
         <span className="text-sm font-normal text-gray-500 dark:text-gray-400"><img width="20" height="20" src="https://img.icons8.com/fluency-systems-filled/20/40C057/double-tick.png" alt="double-tick"/></span>
      </div>
      </div>
   </div>
